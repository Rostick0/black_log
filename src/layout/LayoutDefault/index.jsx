...
export default function LayoutDefault({ children }) {
  ...
  const setActiveRoute = (route) => {
    ...
    return setClassName(styles._active);
  };

  return (
    <div className={styles.LayoutDefault}>
      <div className="container">
        <div className={styles.LayoutDefault_nav}>
          <Link
            className={
          ...
          <svg
            className={styles.LayoutDefault_nav__icon}
            width="34"
            height="32"
            viewBox="0 0 34 32"
            fill="none"
          ...
          <Link
            className={
              styles.LayoutDefault_nav__link + setActiveRoute(routes[2]?.path)
            }
            to={routes[2]?.path}
          >
            {routes[2]?.name}
          ...
          <Link
            className={
              styles.LayoutDefault_nav__link + setActiveRoute(routes[3]?.path)
            }
            to={routes[3]?.path}
          >
            {routes[3]?.name}
